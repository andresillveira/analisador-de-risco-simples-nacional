    ...
    <div id="summary-dashboard-cards" className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs relative overflow-hidden transition-all hover:shadow-md">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[11px] text-slate-500 mt-2 flex items-start gap-1">
            ...
            <span>
              Soma de Vendas Líquidas e Serviços. Devoluções de vendas (Entradas: <b>{formatBRL(results.devolucoesVendas)}</b>) foram abatidas.
            </span>
          </p>
          ...
          <div className="mt-4 pt-3 border-t border-slate-100 flex flex-wrap gap-x-4 gap-y-1 items-center justify-between text-[11px] font-mono text-slate-400">
            <span>Vendas Líq: {formatBRL(results.vendasLiquidas)}</span>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs relative overflow-hidden transition-all hover:shadow-md">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider block">
              Compras Líquidas (Comercialização)
            </span>
          ...
          <p className="text-[11px] text-slate-500 mt-2 flex items-start gap-1">
            ...
            <span>
              Insumos e industrialização. Devoluções de compras aos fornecedores (Saídas: <b>{formatBRL(results.devolucoesCompras)}</b>) foram abatidas.
            </span>
          </p>
          
          <div className="mt-4 pt-3 border-t border-slate-100 flex flex-wrap gap-x-4 gap-y-1 items-center justify-between text-[11px] font-mono text-slate-400">
            <span>Compras Brutas: {formatBRL(results.comprasContabilizadas)}</span>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs relative overflow-hidden transition-all hover:shadow-md">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[11px] text-slate-500 mt-2 flex items-start gap-1">
            ...
            <span>
              Soma de <b>Compras Líquidas</b> + <b>Folha de Pagamento</b> + <b>Despesas Administrativas</b> ocorridas no período fiscal.
            </span>
          </p>
